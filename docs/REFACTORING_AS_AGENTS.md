...
SQL_PARAMETERIZATION_AGENT:
  ...
  steps:
    ...
    2_analyze:
      for_each_statement:
        - tool: dotnet-get-statement-context
    ...
    4_update_signatures:
      if_using_dapper:
        ...
        - tool: dotnet-find-method-callers
    ...
    4_propagate_changes:
      for_each_converted_method:
        ...
        - for_each_caller:
          ...
          - tool: dotnet-replace-statement or dotnet-edit-code
    
    5_handle_interfaces:
      - tool: dotnet-find-implementations
      - tool: dotnet-find-overrides
...
LOGGING_CONVERSION_AGENT:
  ...
  steps:
    ...
    4_add_using:
      if_needed:
        - tool: dotnet-insert-before-symbol
...
[Calls dotnet-find-statements with "SqlCommand"]
Found 3 SQL command instances

Step 2 - Analyzing each query:
[Calls dotnet-get-statement-context for each]
...
[For each statement:]
  ...
  [Calls dotnet-replace-statement]

Step 4 - Updating method signatures:
[Calls dotnet-find-method for containing methods]
Method GetUser needs to return User instead of DataTable
[Calls dotnet-edit-code to update return type]

Step 5 - Updating callers:
[Calls dotnet-find-method-callers]
