...
public class McpJsonRpcServer
{
    ...
    private readonly DotnetWorkspaceManager _workspaceManager;
    ...
    private async Task<object> GetWorkspaceStatusAsync(JsonElement? args)
    {
        ...
        // Synchronize local workspace tracking with DotnetWorkspaceManager
    ...
    private void SynchronizeWorkspaceTracking(dynamic roslynStatus)
    {
        try
        {
            ...
            foreach (var id in toRemove)
            {
                ...
                _logger.LogInformation("Removed workspace {Id} from local tracking (cleaned up by DotnetWorkspaceManager)", id);
            }
        }
        catch (Exception ex)
        {
